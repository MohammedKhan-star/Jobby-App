...
class JobItemDetails extends Component {
  ...
  getFormattedData = data => ({
    companyLogoUrl: data.company_logo_url,
    commpanyWebsiteUrl: data.company_website_url,
    employmentType: data.employment_type,
    id: data.id,
    jobDescription: data.job_description,
    lifeAtCompany: {
        ...
        <div className="job-iten">
          ...
          <div className="description-visit-container">
            ...
            <div className="visit-container">
              <a href={commpanyWebsiteUrl} className="visit-heading">
                Visit
              </a>
            ...
            <div className="life-at-company-description-image-container">
              <p className="life-at-container-description">{description}</p>
              <img
